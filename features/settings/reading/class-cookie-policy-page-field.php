...
final class Cookie_Policy_Page_Field implements Setting_Field
{
	public function id(): string
	{
		return 'wordpress_helfi_cookie_consent_cookie_policy_page_id';
	}

	public function title(): string
	{
		return __( 'Cookie policy page', 'wordpress-helfi-cookie-consent' );
	}
