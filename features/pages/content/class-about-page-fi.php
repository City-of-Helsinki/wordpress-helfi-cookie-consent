...
final class About_Page_Fi
{
	...
	{
		return '<h2 class="wp-block-heading">Evästeet tällä sivustolla</h2>
		...
		<h2 class="wp-block-heading">Tietoa evästeistä</h2>
		...
		<h2 class="wp-block-heading">Evästeet ja sivuston toiminta</h2>
		...
		<h2 class="wp-block-heading">Lisätietoa tietosuojasta ja rekisteröidyn oikeuksista</h2>
		...
		<h2 class="wp-block-heading">Lisätietoa saavutettavuudesta</h2>
		...
		<h2 class="wp-block-heading">Tekstisisältöjen käyttöön riittää maininta lähteestä</h2>
