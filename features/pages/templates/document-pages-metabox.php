					...
					printf(
						'<li>
							<label class="menu-item-title">
								<input type="checkbox" class="menu-item-checkbox" name="menu-item[%3$d][menu-item-object-id]" value="%3$d"> %1$s
							</label>
							<input type="hidden" class="menu-item-type" name="menu-item[%3$d][menu-item-type]" value="%2$s">
							<input type="hidden" class="menu-item-title" name="menu-item[%3$d][menu-item-title]" value="%1$s">
							<input type="hidden" class="menu-item-url" name="menu-item[%3$d][menu-item-url]" value="#">
						</li>',
						\esc_html( $page->title() ),
						\esc_attr( $page->type() ),
						\esc_attr( $page_index )
